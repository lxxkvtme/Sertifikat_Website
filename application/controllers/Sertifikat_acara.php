...
class Sertifikat_acara extends CI_Controller
{
   ...
   public function index()
   {
      ...
      $this->template->load('templates/template', 'menu/sertifikat_acara', $data);
   }
   ...
   {
      $this->M_Acara->deleteAcara($id_acara);
      redirect('Sertifikat_acara');
   }
   ...
   public function editAcara()
   {
      ...
      if ($this->form_validation->run() == FALSE) {
         ...
         $this->M_Acara->editAcara($data, $id_acara);
